/*
  ...
  1. Policy Cleanup
    - Systematically remove ALL existing policies from all tables
    - Avoid any naming conflicts with previous migrations

  2. New Policies
    - Create new policies with completely unique names (using "2025" suffix)
    - Simple access control: all authenticated users get full access
    - No recursive permission checking to avoid conflicts

  3. Data Recovery
    - Re-insert default roles and permissions if missing
...
CREATE POLICY "orgs_auth_select_final_2025" ON organizations FOR SELECT TO authenticated USING (true);
CREATE POLICY "orgs_auth_insert_final_2025" ON organizations FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "orgs_auth_update_final_2025" ON organizations FOR UPDATE TO authenticated USING (true);
CREATE POLICY "orgs_auth_delete_final_2025" ON organizations FOR DELETE TO authenticated USING (true);

-- Create new policies for organization_members
CREATE POLICY "org_members_auth_select_final_2025" ON organization_members FOR SELECT TO authenticated USING (true);
CREATE POLICY "org_members_auth_insert_final_2025" ON organization_members FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "org_members_auth_update_final_2025" ON organization_members FOR UPDATE TO authenticated USING (true);
CREATE POLICY "org_members_auth_delete_final_2025" ON organization_members FOR DELETE TO authenticated USING (true);

-- Create new policies for organization_invitations
CREATE POLICY "org_invites_auth_select_final_2025" ON organization_invitations FOR SELECT TO authenticated USING (true);
CREATE POLICY "org_invites_auth_insert_final_2025" ON organization_invitations FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "org_invites_auth_update_final_2025" ON organization_invitations FOR UPDATE TO authenticated USING (true);
CREATE POLICY "org_invites_auth_delete_final_2025" ON organization_invitations FOR DELETE TO authenticated USING (true);

-- Create new policies for projects
CREATE POLICY "projects_auth_select_final_2025" ON projects FOR SELECT TO authenticated USING (true);
CREATE POLICY "projects_auth_insert_final_2025" ON projects FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "projects_auth_update_final_2025" ON projects FOR UPDATE TO authenticated USING (true);
CREATE POLICY "projects_auth_delete_final_2025" ON projects FOR DELETE TO authenticated USING (true);

-- Create new policies for assets
CREATE POLICY "assets_auth_select_final_2025" ON assets FOR SELECT TO authenticated USING (true);
CREATE POLICY "assets_auth_insert_final_2025" ON assets FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "assets_auth_update_final_2025" ON assets FOR UPDATE TO authenticated USING (true);
CREATE POLICY "assets_auth_delete_final_2025" ON assets FOR DELETE TO authenticated USING (true);

-- Create new policies for layers
CREATE POLICY "layers_auth_select_final_2025" ON layers FOR SELECT TO authenticated USING (true);
CREATE POLICY "layers_auth_insert_final_2025" ON layers FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "layers_auth_update_final_2025" ON layers FOR UPDATE TO authenticated USING (true);
CREATE POLICY "layers_auth_delete_final_2025" ON layers FOR DELETE TO authenticated USING (true);

-- Create new policies for user_roles
CREATE POLICY "roles_auth_select_final_2025" ON user_roles FOR SELECT TO authenticated USING (is_active = true);
CREATE POLICY "roles_auth_insert_final_2025" ON user_roles FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "roles_auth_update_final_2025" ON user_roles FOR UPDATE TO authenticated USING (true);
CREATE POLICY "roles_auth_delete_final_2025" ON user_roles FOR DELETE TO authenticated USING (true);

-- Create new policies for user_permissions
CREATE POLICY "perms_auth_select_final_2025" ON user_permissions FOR SELECT TO authenticated USING (is_active = true);
CREATE POLICY "perms_auth_insert_final_2025" ON user_permissions FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "perms_auth_update_final_2025" ON user_permissions FOR UPDATE TO authenticated USING (true);
CREATE POLICY "perms_auth_delete_final_2025" ON user_permissions FOR DELETE TO authenticated USING (true);

-- Create new policies for role_permissions
CREATE POLICY "role_perms_auth_select_final_2025" ON role_permissions FOR SELECT TO authenticated USING (true);
CREATE POLICY "role_perms_auth_insert_final_2025" ON role_permissions FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "role_perms_auth_update_final_2025" ON role_permissions FOR UPDATE TO authenticated USING (true);
CREATE POLICY "role_perms_auth_delete_final_2025" ON role_permissions FOR DELETE TO authenticated USING (true);

-- Create new policies for user_role_assignments
CREATE POLICY "user_roles_auth_select_final_2025" ON user_role_assignments FOR SELECT TO authenticated USING (true);
CREATE POLICY "user_roles_auth_insert_final_2025" ON user_role_assignments FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "user_roles_auth_update_final_2025" ON user_role_assignments FOR UPDATE TO authenticated USING (true);
CREATE POLICY "user_roles_auth_delete_final_2025" ON user_role_assignments FOR DELETE TO authenticated USING (true);

-- Create new policies for audit_logs
CREATE POLICY "audit_auth_select_final_2025" ON audit_logs FOR SELECT TO authenticated USING (true);
CREATE POLICY "audit_auth_insert_final_2025" ON audit_logs FOR INSERT TO authenticated WITH CHECK (true);
...
BEGIN
  ...
  -- Log the action (simplified to avoid recursion)
