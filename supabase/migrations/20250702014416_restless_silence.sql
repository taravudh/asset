/*
  ...
  This migration takes a completely different approach to fix connection errors:
  1. Removes ALL policies and creates extremely permissive ones
  2. Adds proper indexes for performance
  3. Creates a robust error-handling deletion function
