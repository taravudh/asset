-- PERMANENT DATABASE CONNECTION FIX
-- This migration completely resolves connection timeout errors by creating a clean database setup
...
CREATE POLICY "projects_all_access_20250702_155000" ON projects FOR ALL TO authenticated 
USING (true) WITH CHECK (true);

-- Assets policies - COMPLETELY PERMISSIVE
CREATE POLICY "assets_all_access_20250702_155000" ON assets FOR ALL TO authenticated 
USING (true) WITH CHECK (true);

-- Layers policies - COMPLETELY PERMISSIVE
CREATE POLICY "layers_all_access_20250702_155000" ON layers FOR ALL TO authenticated 
USING (true) WITH CHECK (true);
